		...
		methods: {
			...
			saveTransaction: function() {
				if($('#description').val()=='') {
					...
					$('#account select').val('Wallet');
					$('#account .item-after').text($('#account select').val());
					$('#categories select').val(['Food']);
					$('#categories .item-after').text('Food');
				}
				else if($('#description').val()=='p') {
					$('#description').val('Petrol');
					$('#account select').val('Credit Card');
					$('#account .item-after').text($('#account select').val());
					$('#categories select').val(['Transport']);
					$('#categories .item-after').text('Transport');
				}
