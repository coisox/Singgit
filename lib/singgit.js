	...
	singgit = new Vue({
		...
		methods: {
			...
			addFavourite: function() {
				...
				$('#description').favourite('setOptions', { lookup: this.favourite });
			},
			deleteFavourite: function(index) {
				this.favourite.splice(index, 1);
			},
			draftFavourite: function() {
				var _this = this;
				...
				db.doc("favourite").get().then(function(querySnapshot) {
					...
					_this.favourite.sort(function(a, b){
			...
			saveFavourite: function() {
				...
				//====================================================================================================== save favourite to localstorage
				localStorage.setItem('SINGGIT_Favourite', JSON.stringify(_this.favourite));
				$('#description').autocomplete('setOptions', { lookup: _this.favourite });
