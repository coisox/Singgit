	...
	app = new Vue({
		...
		methods: {
			...
			*/
			...
			zzzfilteredTransactions: function() {
				this.logTimelapse("Begin filteredTransactions");
				var _this = this;
				...
				this.logTimelapse("End filteredTransactions");
		...
		mounted: function() {
			...
			if($('.nav-pills').is('.d-md-none')) _this.fetchTransactions();
